...
router.post('/', authorize('hotel_manager', 'admin'), validateRequest(createTaskSchema), tasksController.createTask);

// Update task (managers only)
router.put('/:id', authorize('hotel_manager', 'admin'), validateRequest(updateTaskSchema), tasksController.updateTask);
...
router.post('/:id/verify', authorize('hotel_manager', 'admin'), validateRequest(verifyTaskSchema), tasksController.verifyTask);

// Delete task (managers only)
router.delete('/:id', authorize('hotel_manager', 'admin'), tasksController.deleteTask);
